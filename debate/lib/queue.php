...
function adminQueue($panel, $base, $fileDir) {
	include 'header.php';	
	...
	<title>Debate Queue</title>
	<body>
		<div class="jumbotron vertical-center" style="background-color:inherit;">
			<div class="container">
			<div class="row">
				<div class="col-8">
					<a href="<?php echo $base . $fileDir . "/" . $panel; ?>" style="border-bottom: none;"><img style="width: 100%; height: auto;" src="<?php echo $fileDir; ?>/images/queue-panel.png" alt=""></a>
				</div>
			</div><br>					
